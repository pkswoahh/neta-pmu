...
- [ ] **Conocido — scroll "tieso" en páginas con poco contenido:** por el bloqueo de scroll del documento (fix del teclado), una página sin suficiente contenido no hace el "rebote" natural de iOS. Revisar post-lanzamiento (implicaría rediseñar el modelo de scroll; no urgente).
